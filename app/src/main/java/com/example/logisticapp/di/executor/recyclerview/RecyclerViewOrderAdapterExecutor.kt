...
class RecyclerViewOrderAdapterExecutor constructor(private val getActivity: ExecutorMainActivity, private val orderList: List<OrderRecycler>) :
    RecyclerView.Adapter<RecyclerViewOrderAdapterExecutor.MyViewHolder>() {
